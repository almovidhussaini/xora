...
const Termandcondition = () => {
    return (
        <section id="tnc" className="contact-bg" style={{backgroundColor: '#080B2A', color: 'white', marginBottom:'-3rem', paddingBottom:'-4rem', paddingTop:'2rem'}}>
      <div className="container">
        ...
        <div className="contact-info-wrap">
          <div className=" col-lg-12 ">
            ...
            A total of 369,000,000 Xora tokens have been allocated for all
            stages combined.
            <br />
            <br />
            <strong>- User Spending Limit: </strong>
            Each participant is allowed a maximum spending limit of 5,000 USD
            (USDT/USDC) during the sale, ensuring equal opportunity for all
            buyers.
            <br />
            <br />
            ...
            allocation of 33,000,000 Xora tokens has been designated for this
            ...
            can support others in joining the sale. For every XORA token
