          ...
          <div className="col-12 col-md-6 mb-3 mb-md-0 text-center">
            <div>
              ...
              <p style={{ fontSize: "0.9rem", lineHeight: "1.6" }}>
                At Xoraland, we are reshaping gaming by blending fun, quality
                gameplay, and the transformative power of blockchain. With our
                play-to-earn model, you earn our native token Xora as you
                explore a wide range of engaging games.
              </p>
